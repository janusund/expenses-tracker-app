...
export const EXPENSES = [
  new Expense("e1", "A Book", 4.50, new Date("2020-02-19")),
  ...
  new Expense("e12", "Spotify Premium", 9.99, new Date("2022-03-01")),
  new Expense("e13", "Phone Case", 19.99, new Date("2024-02-20")),
];